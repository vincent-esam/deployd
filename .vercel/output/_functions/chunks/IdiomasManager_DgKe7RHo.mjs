...
const IdiomasManager = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "idiomas-manager", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "idiomas-list", children: docenteData?.idiomas.filter((idioma) => idioma !== null).map((idioma) => /* @__PURE__ */ jsxs(
      "div",
      {
      ...
      idioma.idIdiomaDocente || idioma.idIdioma
    )) }),
    showAddModal && /* @__PURE__ */ jsx("div", { className: "modalidioma-add-overlay", children: /* @__PURE__ */ jsxs("div", { className: "modalidioma-add", children: [
      ...
      /* @__PURE__ */ jsx(
        IdiomasSelect,
        {
          ...
          onIdiomaChange: (selected) => setNewIdioma({
            ...newIdioma,
      ...
      ["escritura", "oral", "lectura", "escucha"].map((field) => /* @__PURE__ */ jsxs("div", { className: "modalidioma-add-checkbox-group", children: [
      ...
      /* @__PURE__ */ jsx("button", { className: "modalidioma-add-button", onClick: handleAddIdioma, children: "Agregar" }),
      /* @__PURE__ */ jsx("button", { className: "modalidioma-add-button-close", onClick: closeAddModal, children: "Cerrar" })
    ] }) }),
    showEditModal && selectedIdioma && /* @__PURE__ */ jsx("div", { className: "modalidioma-overlay", children: /* @__PURE__ */ jsxs("div", { className: "modalidioma", children: [
      ...
      ["escritura", "oral", "lectura", "escucha"].map((field) => /* @__PURE__ */ jsxs("div", { className: "modalidioma-checkbox-group", children: [
        /* @__PURE__ */ jsx("label", { children: field.charAt(0).toUpperCase() + field.slice(1) }),
        ["Alto", "Medio", "Bajo"].map((level, index) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(
            "input",
      ...
      /* @__PURE__ */ jsx("button", { className: "modalidioma-button", onClick: handleUpdateIdioma, children: "Actualizar" }),
      /* @__PURE__ */ jsx("button", { className: "modalidioma-button-close", onClick: closeEditModal, children: "Cerrar" })
    ] }) })
  ] });
};
