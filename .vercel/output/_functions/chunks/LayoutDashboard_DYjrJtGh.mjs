import { c as createComponent, f as renderHead, d as renderComponent, e as renderSlot, r as renderTemplate } from './astro/server_CdpYlLHK.mjs';
import 'kleur/colors';
...
const HeaderDash = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("header", { className: "header-dash", children: [
      /* @__PURE__ */ jsxs("div", { className: "header-left", children: [
        /* @__PURE__ */ jsx("a", { className: "header-logo-desktop", href: "/dashboard" }),
        /* @__PURE__ */ jsx("a", { className: "header-logo-mobile", href: "/dashboard" }),
        /* @__PURE__ */ jsx("span", { className: "header-title-mobile", children: "Dashboard" })
      ] }),
      /* @__PURE__ */ jsx("button", { className: "header-logout-button", onClick: handleLogout, children: "Cerrar Sesión" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "header-bar" })
  ] });
};
...
const Slidebar = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "slidebar", children: [
    ...
    /* @__PURE__ */ jsxs("ul", { className: "menu", children: [
      /* @__PURE__ */ jsxs("li", { className: "menu-item", children: [
        " ",
        /* @__PURE__ */ jsx("a", { href: "/dashboardDoc", children: /* @__PURE__ */ jsx("span", { children: "Perfil" }) })
      ] }),
      /* @__PURE__ */ jsx("li", { className: "menu-item", children: "Configuración" }),
      /* @__PURE__ */ jsx("li", { className: "menu-item", children: /* @__PURE__ */ jsx("a", { href: "/dashboardDoc/archivosDocentes/archivos", children: /* @__PURE__ */ jsx("span", { children: "Subir Archivos" }) }) }),
      /* @__PURE__ */ jsx("li", { className: "menu-item", children: /* @__PURE__ */ jsx("a", { href: "/dashboardDoc/convocatorias/convocatoria", children: /* @__PURE__ */ jsx("span", { children: "Convocatorias" }) }) })
    ] })
  ] });
};
...
}, "C:/Users/TIESA/OneDrive/Escritorio/Astrojs-academic/academic/src/layouts/LayoutDashboard.astro", void 0);

export { $$LayoutDashboard as $ };
