...
const ProduccionesIntelectualesManager = () => {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      setProducciones(
        (prev) => prev.map(
          (prod) => prod.idProduccionIntelectual === editingProduccion.idProduccionIntelectual ? editingProduccion : prod
        )
      );
      closeModals();
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "producciones-manager", children: [
    ...
    !loading && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "producciones-list", children: producciones.map((produccion) => /* @__PURE__ */ jsxs(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        CountrySelect,
        {
          ...
          selectedCountry: {
            ...
            // Asegúrate de que esté el valor correcto aquí
          },
